"""V04 case-3 fix: dismiss wizard before help tests. Re-run cases 2/3 cleanly."""
...
with sync_playwright() as p:
    ...
    # Case 3: single modal Esc + focus restore
    ctx = browser.new_context(viewport={"width": 1280, "height": 900})
    page = ctx.new_page()
    page.on("pageerror", lambda e: errors.append("V04:" + str(e)))
    setup(page)
    ...
    # wizard-alone Esc (with initWithYard side effect — the app still initializes)
