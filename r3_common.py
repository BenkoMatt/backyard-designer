"""S29 Agent R3 (FINISH-MODALS) shared helpers — CDP sweep + glm-5.3-flash vision QA.

Adapted from s29a_common.py (audit-modals harness, shared version) for worktree
/root/byd29r-modals on port 8230.
Rules honored:
...
- Server: port 8230 (owned by this agent). Never touch 8099/8115/8175/8093/8095/8186.
"""
import base64
import json
import os
...
def vision_qa(png_path, prompt=QA_PROMPT, retries=4):
...
def dismiss_overlays(page):
    """Close toast/hints if any — via Escape key (real key event)."""
