#!/usr/bin/env python3
"""Sprint 25 BEFORE captures: full app + every panel open, at 1280x800 and 1920x1080.
...
try:
    ...
    # full app baseline
    shot(page, f'{OUT}/sprint25_before_1_full_1280.png')
    ...
    for name, sel, close in PANELS:
        try:
            ...
            shot(page, f'{OUT}/sprint25_before_2_{name}.png')
    ...
    for name, sel in TOPBAR:
        try:
            ...
            shot(page, f'{OUT}/sprint25_before_3_{name}.png')
    ...
    page.wait_for_timeout(600)
    shot(page, f'{OUT}/sprint25_before_4_full_1920.png')
    ...
    for name, sel in [("dock_terrain", '.td-tab[data-dock="terrain"]'), ("cost", '#btn-cost'), ("help", '#btn-help')]:
        try:
            ...
            if el and el.is_visible():
                el.click()
                page.wait_for_timeout(600)
                shot(page, f'{OUT}/sprint25_before_5_{name}_1920.png')
...
json.dump(report, open('/root/backyard-designer/sprint25_before_geometry.json', 'w'), indent=1)
